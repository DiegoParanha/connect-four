...
const COLORS = {
  ...
  function handleDrop(evt) {
    ...
    // Guards to not be able to click around the markers...
    if(colIdx === -1) return;
  ...
  // Check for winner in board state and return null if no winnner, 1/-1 if a player has won, or 'T' if tie
  function getWinner(colIdx, rowIdx) {
    return checkVerticalWin(colIdx, rowIdx) || checkHorizontalWin(colIdx, rowIdx) || checkDiagonalWinNESW(colIdx,rowIdx) || checkDiagonalWinNWSE(colIdx,rowIdx); 
